...
export function createPdfParseHelpers({
  ...
  function parseInventoryForecastRowsFromPdfBuffer(rawBuffer, fallbackBizType = '', options = {}) {
    ...
    let parsed = parseInventoryForecastRowsFromTableMatrix(matrix, fallbackBizType, options);
  ...
  function parseInventoryForecastRowsFromPdfPath(pdfPath, fallbackBizType = '', options = {}) {
    ...
    try {
      ...
      const parsed = parseInventoryForecastRowsFromTableMatrix(matrix, fallbackBizType, options);
      if (parsed.length) return parsed;
