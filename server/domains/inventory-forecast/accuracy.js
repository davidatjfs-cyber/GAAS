export function normalizePredictionItems(input) {
...
export function forecastPredictionToProductMap(predictions) {
  const map = {};
...
export function calcForecastAccuracyMetrics(normalizeForecastProducts, predictions, actualProducts) {
...
export function buildForecastCalibrationFactors(evaluations, asOfDate) {
...
export function applyForecastCalibration(predictions, calibration) {
...
export function summarizeForecastAccuracyRows(items) {
...
export function createAccuracyHelpers({ normalizeForecastProducts }) {
  return {
    ...
    calcForecastAccuracyMetrics: (predictions, actualProducts) =>
      calcForecastAccuracyMetrics(normalizeForecastProducts, predictions, actualProducts),
