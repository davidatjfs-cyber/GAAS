...
export function buildMasterIntervalSchedule(ticks) {
  return [
    { fn: ticks.auditTick, intervalMs: 15 * 1000, startupDelayMs: 10 * 1000 },
    { fn: ticks.dispatchTick, intervalMs: 15 * 1000, startupDelayMs: 15 * 1000 },
    { fn: ticks.opsTick, intervalMs: 20 * 1000, startupDelayMs: 20 * 1000 },
    { fn: ticks.postResTick, intervalMs: 20 * 1000, startupDelayMs: 25 * 1000 },
    { fn: ticks.evalTick, intervalMs: 30 * 1000, startupDelayMs: 30 * 1000 },
    { fn: ticks.finalTick, intervalMs: 30 * 1000, startupDelayMs: 35 * 1000 },
    { fn: ticks.trainTick, intervalMs: 60 * 1000, startupDelayMs: 40 * 1000 },
    { fn: ticks.issuesTick, intervalMs: 30 * 1000, startupDelayMs: 45 * 1000 },
    { fn: ticks.trainDispatchTick, intervalMs: 10 * 60 * 1000, startupDelayMs: 50 * 1000 },
    { fn: ticks.optimizationTick, intervalMs: 60 * 1000, startupDelayMs: 55 * 1000 },
    { fn: ticks.taskResponseTick, intervalMs: 60 * 1000, startupDelayMs: 60 * 1000 },
    { fn: ticks.kgHealthTick, intervalMs: 6 * 60 * 60 * 1000, startupDelayMs: 90 * 1000 },
    { fn: ticks.inspectionLoopTick, intervalMs: 15 * 60 * 1000, startupDelayMs: 120 * 1000 },
    { fn: ticks.biPushTick, intervalMs: 15 * 60 * 1000, startupDelayMs: 150 * 1000 },
    { fn: ticks.laborTick, intervalMs: 15 * 60 * 1000, startupDelayMs: 180 * 1000 },
    { fn: ticks.trainingLoopTick, intervalMs: 15 * 60 * 1000, startupDelayMs: 210 * 1000 },
  ];
}
