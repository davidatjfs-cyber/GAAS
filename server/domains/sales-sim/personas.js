...
export const BUILTIN_PERSONAS = [
  ...
  {
    persona_key: 'cs_member_points_rule',
    track: 'cs', audience: 'both', source_type: 'builtin', difficulty: 2,
    title: '老板咨询 · 会员积分规则',
    opening_line: '我们店的会员积分规则现在是怎么算的？顾客充值消费的积分能不能抵现？这个规则我们能自己调吗？',
    profile: { role: '老板', issue: 'member_points_rule', emotion: 'curious', traits: ['业务咨询', '要准确答案'], objections: [] },
  },
  {
    persona_key: 'cs_stored_value_rule',
    track: 'cs', audience: 'both', source_type: 'builtin', difficulty: 2,
    title: '老板咨询 · 储值充送规则',
    opening_line: '我们店准备做储值充送，赠送的金额能不能退？余额能不能跨店用？规则由你们平台定还是我们能自己设？',
    profile: { role: '老板', issue: 'stored_value_rule', emotion: 'neutral', traits: ['业务咨询', '要边界答案'], objections: [] },
  },
  {
    persona_key: 'cs_activity_setup',
    track: 'cs', audience: 'internal', source_type: 'builtin', difficulty: 3,
  ...
  {
    persona_key: 'cs_billing_dispute',
    track: 'cs', audience: 'internal', source_type: 'builtin', difficulty: 3,
    title: '老板对账 · 流水与退款时效',
    opening_line: '昨天订单流水和后台对不上，我这边会员的退款也还没到账，你们到底怎么核的？',
    profile: { role: '老板', issue: 'billing_dispute', emotion: 'anxious', traits: ['要查证', '要时限'], objections: ['complaint'] },
  },
  {
