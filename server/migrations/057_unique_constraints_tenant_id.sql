...
BEGIN
  ...
  END IF;
  IF to_regclass('public.kitchen_reports') IS NOT NULL THEN
  ...
  END IF;
  IF to_regclass('public.store_meeting_reports') IS NOT NULL THEN
  ...
  END IF;
  IF to_regclass('public.material_receiving_reports') IS NOT NULL THEN
