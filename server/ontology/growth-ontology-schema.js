...
const statements = [
  `CREATE TABLE IF NOT EXISTS growth_ontology_stores (
    store_id text PRIMARY KEY, tenant_id text NOT NULL DEFAULT 'default', name text, city text,
  ...
  `CREATE TABLE IF NOT EXISTS growth_ontology_customers (
    customer_id text PRIMARY KEY, tenant_id text NOT NULL DEFAULT 'default', store_id text, phone text,
  ...
  `CREATE TABLE IF NOT EXISTS growth_ontology_dishes (
    dish_id text PRIMARY KEY, tenant_id text NOT NULL DEFAULT 'default', store_id text, name text,
  ...
  `CREATE TABLE IF NOT EXISTS growth_ontology_orders (
    order_id text PRIMARY KEY, tenant_id text NOT NULL DEFAULT 'default', store_id text, customer_id text,
  ...
  `CREATE TABLE IF NOT EXISTS growth_ontology_employees (
    employee_id text PRIMARY KEY, tenant_id text NOT NULL DEFAULT 'default', store_id text, name text,
  ...
  `CREATE TABLE IF NOT EXISTS growth_ontology_campaigns (
    campaign_id text PRIMARY KEY, tenant_id text NOT NULL DEFAULT 'default', store_id text, name text,
  ...
  `CREATE TABLE IF NOT EXISTS growth_ontology_benefits (
    benefit_id text PRIMARY KEY, tenant_id text NOT NULL DEFAULT 'default', store_id text, campaign_id text,
  ...
  `CREATE TABLE IF NOT EXISTS growth_ontology_touches (
    touch_id text PRIMARY KEY, tenant_id text NOT NULL DEFAULT 'default', store_id text, customer_id text,
  ...
  `CREATE TABLE IF NOT EXISTS growth_ontology_issues (
    issue_id text PRIMARY KEY, tenant_id text NOT NULL DEFAULT 'default', store_id text, issue_type text,
  ...
  `CREATE TABLE IF NOT EXISTS growth_ontology_opportunities (
    opportunity_id text PRIMARY KEY, tenant_id text NOT NULL DEFAULT 'default', store_id text, issue_id text,
  ...
  `CREATE TABLE IF NOT EXISTS growth_ontology_attributions (
    attribution_id text PRIMARY KEY, tenant_id text NOT NULL DEFAULT 'default', store_id text, campaign_id text,
  ...
  `CREATE TABLE IF NOT EXISTS growth_ontology_business_results (
    result_id text PRIMARY KEY, tenant_id text NOT NULL DEFAULT 'default', store_id text, result_type text,
