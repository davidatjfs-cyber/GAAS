...
const L1_FILE_FLOOR = {
  'domains/approvals/handlers/leave.js': { branches: 80, lines: 95 },
  'domains/approvals/handlers/offboarding.js': { branches: 79, lines: 95 },
  'domains/approvals/handlers/points.js': { branches: 74, lines: 95 },
  'domains/approvals/handlers/onboarding.js': { branches: 73, lines: 95 },
  'domains/approvals/handlers/promotion.js': { branches: 77, lines: 95 },
