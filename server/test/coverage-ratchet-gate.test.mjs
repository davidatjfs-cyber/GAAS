...
const L1_FILE_FLOOR = {
  ...
  'domains/approvals/handlers/points.js': { branches: 79, lines: 95 },
  'domains/approvals/handlers/onboarding.js': { branches: 79, lines: 95 },
  'domains/approvals/handlers/promotion.js': { branches: 79, lines: 95 },
